  ...
  return (
    <>
      <header>
        ...
        <div class="menu">
          <i class="more-icon sm-icon"></i>Show Menu</div>
        <div class="subscribed">
          <i class="sub-icon sm-icon"></i>Subscribed</div>
      </header>
      <main>
          <div id="list-container" class="list-container">
              ...
              </div><div id="new-list" class="new-list"><span>Add a list...</span>
                  <input type="text" placeholder="Add a list..." />
                  <div>
                      <input type="submit" class="button" value="Save" /><i class="x-icon icon"></i>
                  </div>
              </div>
          </div>
      </main>
      <div class="menu-sidebar">
          <div id="menu-main" class="main slide"><i class="back-icon icon"></i><i class="x-icon icon"></i>
              <h1>Menu</h1>
              <div class="menu-contents">
                  ...
                  <div class="add-members"><i class="add-icon sm-icon"></i>Add Members...</div>
                  <hr />
                  <ul class="menu-list">
                  ...
                  <ul class="activity-list">
                      <li><i class="member-icon"></i>
                          <p><span class="member-name">Taylor Peat</span> changed the background of this board <small>yesterday at 4:53 PM</small>
                          </p>
                      </li>
                      <li><i class="member-icon"></i>
                          <p><span class="member-name">Taylor Peat</span> sent <span class="link">Use the + in the top menu to make your first board now.</span> to the board <small>4 hours ago</small>
                          </p>
                      </li>
                      <li><i class="member-icon"></i>
                          <p><span class="member-name">Taylor Peat</span> archived <span class="link">Use the + in the top menu to make your first board now.</span> <small>4 hours ago</small>
                          </p>
                      </li>
                      <li><i class="member-icon"></i>
                          <p><span class="member-name">Taylor Peat</span> changed the background of this board <small>5 hours ago</small>
                          </p>
                      </li>
                      <li><i class="member-icon"></i>
                          <p><span class="member-name">Taylor Peat</span> changed the background of this board <small>6 hours ago</small>
                          </p>
                      </li>
                      <li><i class="member-icon"></i>
                          <p><span class="member-name">Taylor Peat</span> changed the background of this board <small>yesterday at 10:23 PM</small>
                          </p>
                      </li>
                  </ul><a class="all-activity not-implemented">View all activity...</a>
              </div>
          </div>
      </div>
